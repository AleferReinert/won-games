...
export type GenericMorph =
  ...
  | ComponentPagePopularProducts
  | ComponentPageRibbon
  | ComponentPageSection
  | ComponentPageSocialLink
  | Developer
  | Home
  | I18NLocale
  | Order
...
export type BannerFragment = {
  ...
  title?: string
  description?: string
  img: { __typename?: 'UploadFile'; url: string; alternativeText?: string }
  button?: { __typename?: 'ComponentPageButton'; label?: string; url: string }
  ribbon?: {
    __typename?: 'ComponentPageRibbon'
    label: string
    color: Enum_Componentpageribbon_Color
...
export type HighlightFragment = {
  ...
  background: { __typename?: 'UploadFile'; url: string; alternativeText?: string }
  floatImg?: { __typename?: 'UploadFile'; url: string; alternativeText?: string }
}
...
export type PopularProductsFragment = {
  ...
  cover: { __typename?: 'UploadFile'; url: string; alternativeText?: string }
}
...
export type ProductRelationFragment = {
  __typename?: 'Product'
  documentId: string
  slug: string
  name: string
...
export type UpdateWishlishMutation = {
  __typename?: 'Mutation'
  updateWishlist?: {
    __typename?: 'Wishlist'
    documentId: string
    user?: { __typename?: 'UsersPermissionsUser'; documentId: string; username: string }
    products: Array<{
      __typename?: 'Product'
      documentId: string
      slug: string
...
export type CompanyQuery = {
  ...
  company?: {
    ...
    country: string
    complement?: string
    logoLight: { __typename?: 'UploadFile'; url: string; width?: number; height?: number; formats?: any }
    logoDark: { __typename?: 'UploadFile'; url: string; width?: number; height?: number }
    logoIcon: { __typename?: 'UploadFile'; url: string; width?: number; height?: number }
    socialLinks?: Array<{ __typename?: 'ComponentPageSocialLink'; name: string; url: string }>
  }
}
...
export type OrdersQuery = {
  ...
  orders: Array<{
    ...
    products: Array<{
      ...
      name: string
      price?: number
      cover: { __typename?: 'UploadFile'; formats?: any }
    }>
  }>
}
...
export type PlatformsQuery = {
  __typename?: 'Query'
  platforms: Array<{ __typename?: 'Platform'; name: string; slug: string }>
}
...
export type ProductBySlugQuery = {
  ...
  products: Array<{
    ...
    cover: { __typename?: 'UploadFile'; url: string; alternativeText?: string }
    gallery: Array<{ __typename?: 'UploadFile'; url: string; alternativeText?: string }>
    developers: Array<{ __typename?: 'Developer'; name: string }>
...
export type ProfileQuery = {
  __typename?: 'Query'
  usersPermissionsUsers: Array<{ __typename?: 'UsersPermissionsUser'; email: string; username: string }>
}
...
export type UpdateWishlishMutationOptions = Apollo.BaseMutationOptions<
  UpdateWishlishMutation,
  UpdateWishlishMutationVariables
>
...
`
export type RecommendedProductsQueryResult = Apollo.QueryResult<
